...
<head>
    ...
    <meta name="keywords" 	 content="acerca de,informacion, La última partida, pc, ps4, xbox, one, ps5, xbox, series, x"/>
    <meta name="description" content="Información sobre laultimapartida.com tu página con las últimas noticias en tecnología y videojuegos en español"/>
...
<?php
    ...
    function contenido(){?>
        <article id="articulo">
            ...
            <br><br>
            <div id="texto">
                <p><a href="https://laultimapartida.com"><b>LaUltimaPartida.com</b></a> es una página web en la que encontrarás las últimas noticias sobre el mundo de los videojuegos, hardware y tecnología.</p>
            </div>
        </article>
    <?php
    }
